        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Penulis</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_penulis ?></div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card shadow mb-4" style="width: 1000px;">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> aaaa
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> bbbb
                        </span>
                        <span class="mr-2">
