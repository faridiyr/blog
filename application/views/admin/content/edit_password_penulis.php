 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4" style="max-width: 1200px;">
         ...
         <div class="card-body">
             <form action="<?= site_url('Kelola_Profile_Penulis/edit_password') ?>" method="POST" autocomplete="on" enctype="multipart/form-data">
                 ...
                 <button type="submit" name="simpan" href="<?= site_url('Kelola_Profile_Penulis/edit_password') ?>" class="btn btn-primary">
                     Simpan
                 </button>
             </form>
         </div>
